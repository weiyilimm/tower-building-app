...
public class User_Data : MonoBehaviour{
    ...
    void Start(){
        ...
        Building Main = new Building(0,0,1,500);
        building_stats.Add(Main);
        Building Art = new Building(0,0,1,450);
        building_stats.Add(Art);
        Building Biology_Chemistry = new Building(0,0,1,400);
        building_stats.Add(Biology_Chemistry);
        Building ComputerScience = new Building(0,0,1,350);
        building_stats.Add(ComputerScience);
        Building Engineering = new Building(0,0,1,300);
        building_stats.Add(Engineering);
        Building Geography_History = new Building(0,0,1,250);
        building_stats.Add(Geography_History);
        Building Languages = new Building(0,0,1,200);
        building_stats.Add(Languages);
        Building Law_Politics = new Building(0,0,1,150);
        building_stats.Add(Law_Politics);
        Building Physics_Maths = new Building(0,0,1,100);
